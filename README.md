...
A 2D game built with Phaser, Vite, and TypeScript.

Scaffolded from the [official Phaser Vite TypeScript template](https://github.com/phaserjs/template-vite-ts).
