...
import { NARRATION_TITLE, NARRATION_BODY, CORRECT_ANSWERS, CORRECT_POINTS, INCORRECT_POINTS } from '../data/quiz/france';
...
// Free-text follow-up to Spain, and the last of this run of photo beats:
// expects the country name "France".
export class France extends Scene
{
    ...
    create ()
    {
        ...
        this.fitToCanvas(this.add.image(CENTER_X, CENTER_Y, 'france'));
    ...
    private showContinue (): void
    {
        ...
        const button = new Button(this, {
            ...
            label: 'CONTINUE',
            confirmOnEnter: true,
            onClick: () => this.scene.start('FindTheCar')
        });
