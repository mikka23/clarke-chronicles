...
import { NARRATION_TITLE, NARRATION_BODY, CORRECT_ANSWERS, CORRECT_POINTS, INCORRECT_POINTS } from '../data/quiz/greyMaresTail';
...
// Free-text follow-up to the Butlins beat: rather than a multiple-choice
// panel, the player types the location name into a real HTML input (typos
// tolerated via fuzzyMatch) before continuing on to the main hub.
export class GreyMaresTail extends Scene
{
    ...
    create ()
    {
        ...
        this.fitToCanvas(this.add.image(CENTER_X, CENTER_Y, 'grey-mares-tail'));
    ...
    private showContinue (): void
    {
        ...
        const button = new Button(this, {
            ...
            label: 'CONTINUE',
            confirmOnEnter: true,
            onClick: () => this.scene.start('WinnyAndIveys')
        });
