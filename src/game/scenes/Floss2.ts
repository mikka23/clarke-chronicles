...
import { choices, QuizChoice, CORRECT_KEY, CORRECT_POINTS, INCORRECT_POINTS, NARRATION_BODY } from '../data/quiz/floss2';
...
// Second "identify the dog" beat, straight after the Floss video: a still
// photo this time, with the same Amber/Floss choices shown immediately.
export class Floss2 extends Scene
{
    ...
    create ()
    {
        ...
        this.fitToCanvas(this.add.image(CENTER_X, CENTER_Y, 'floss2'));
    ...
    private showContinue (): void
    {
        const button = new Button(this, {
            ...
            label: 'CONTINUE',
            confirmOnEnter: true,
            onClick: () => this.scene.start('Amber1')
        }).setDepth(2);
