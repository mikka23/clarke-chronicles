...
import { NARRATION_TITLE, NARRATION_BODY, CORRECT_ANSWERS, CORRECT_POINTS, INCORRECT_POINTS } from '../data/quiz/newForest';
...
// Free-text follow-up to Winny and Ivey's: same photo-then-type-the-answer
// beat, this time expecting "New Forest" (with or without "the").
export class NewForest extends Scene
{
    ...
    create ()
    {
        ...
        this.fitToCanvas(this.add.image(CENTER_X, CENTER_Y, 'new-forest'));
