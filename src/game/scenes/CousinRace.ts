...
import { NARRATION_TITLE, NARRATION_BODY, CORRECT_ANSWERS, CORRECT_POINTS, INCORRECT_POINTS } from '../data/quiz/cousinRace';
...
// Follows PaulCartoon, straight before Plum: a plain free-text recall
// question with no photo beat.
export class CousinRace extends Scene
{
    ...
    create ()
    {
        ...
        this.fitToCanvas(this.add.image(CENTER_X, CENTER_Y, 'cousins'));
