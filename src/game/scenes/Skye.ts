...
import { NARRATION_TITLE, NARRATION_BODY, CORRECT_ANSWERS, CORRECT_POINTS, INCORRECT_POINTS } from '../data/quiz/skye';
...
// Free-text follow-up to Mull, another island photo beat: expects "Skye".
export class Skye extends Scene
{
    ...
    create ()
    {
        ...
        this.fitToCanvas(this.add.image(CENTER_X, CENTER_Y, 'skye'));
    ...
    private showContinue (): void
    {
        ...
        const button = new Button(this, {
            ...
            label: 'CONTINUE',
            confirmOnEnter: true,
            onClick: () => this.scene.start('Spain')
        });
