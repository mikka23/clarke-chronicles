...
import { choices, QuizChoice, CORRECT_KEY, CORRECT_POINTS, INCORRECT_POINTS, NARRATION_BODY } from '../data/quiz/amber1';
...
// Third "identify the dog" beat, straight after Floss2: same Amber/Floss
// choices, this time over a photo of Amber.
export class Amber1 extends Scene
{
    ...
    create ()
    {
        ...
        this.fitToCanvas(this.add.image(CENTER_X, CENTER_Y, 'amber1'));
    ...
    private showContinue (): void
    {
        const button = new Button(this, {
            ...
            label: 'CONTINUE',
            confirmOnEnter: true,
            onClick: () => this.scene.start('Amber2')
        }).setDepth(2);
