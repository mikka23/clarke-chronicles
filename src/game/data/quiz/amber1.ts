...
export const NARRATION_BODY = QUIZ_TEXT.amber1.narrationBody;

export const choices: QuizChoice[] = [
    { key: 'amber', label: QUIZ_TEXT.amber1.choices.amber },
    { key: 'floss', label: QUIZ_TEXT.amber1.choices.floss }
];
