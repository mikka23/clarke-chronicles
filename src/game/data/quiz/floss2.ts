...
export const NARRATION_BODY = QUIZ_TEXT.floss2.narrationBody;

export const choices: QuizChoice[] = [
    { key: 'amber', label: QUIZ_TEXT.floss2.choices.amber },
    { key: 'floss', label: QUIZ_TEXT.floss2.choices.floss }
];
